...
namespace BuzzBattle.Animations
{
    public class Animator
    {
        ...
        /// <summary>
        /// Gets the source rectangle of the image by frame.
        /// </summary>
        /// <param name="frame">The frame you want.</param>
        /// <returns>The frame you need.</returns>
        public Rectangle GetSourceRectangle(int frame)
        {
            return new Rectangle(frame * this.sourceRectangle.Width,
                this.yOffset, this.sourceRectangle.Width, this.sourceRectangle.Height);
        }
    }
}
