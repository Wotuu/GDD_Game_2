        ...
        public static Rectangle GetDrawRectangle(int index)
        {
            ...
            if (index < 2)
                rect = new Rectangle(MiniGameOverviewMainGame.GetInstance().game.GraphicsDevice.Viewport.Width -
                    (int)(BALLOON_POPPER_DESCRIPTION.Width * scale.X) - 20,
                    30, (int)(BALLOON_POPPER_DESCRIPTION.Width * scale.X),
                    (int)(BALLOON_POPPER_DESCRIPTION.Height * scale.Y));
            else
                rect = new Rectangle(30, 30, (int)(BALLOON_POPPER_DESCRIPTION.Width * scale.X),
                    (int)(BALLOON_POPPER_DESCRIPTION.Height * scale.Y));
